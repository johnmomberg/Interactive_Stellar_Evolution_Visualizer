...
import src.data.stars.sub_stage 
...
@dataclass 
class MESA_model(src.data.stars.base_class.BaseEntity): 
    mass: float 
    substage: src.data.stars.sub_stage.SubStage 
    model_start: int 
    model_example: int 
    model_end: int 
...
MODEL_0_2_NONE = MESA_model( 
    mass=0.2, 
    substage=src.data.stars.sub_stage.SUB_NONE, 
    model_start=None, 
    model_example=None, 
    model_end=None, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"M=0.2")

MODEL_0_2_HAYASHI = MESA_model( 
    mass=0.2, 
    substage=src.data.stars.sub_stage.SUB_HAYASHI, 
    model_start=None, 
    model_example=150, 
    model_end=None, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"M=0.2") 
...
MODEL_0_2_MS = MESA_model( 
    mass=0.2, 
    substage=src.data.stars.sub_stage.SUB_MS_LOWMASS, 
    model_start=None, 
    model_example=273, 
    model_end=None, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"M=0.2") 
...
MODEL_0_2_HEWD = MESA_model( 
    mass=0.2, 
    substage=src.data.stars.sub_stage.SUB_WD_HE, 
    model_start=None, 
    model_example=1200, 
    model_end=None, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"M=0.2") 
...
MODEL_0_4_NONE = MESA_model( 
    ...
    model_example=None, 
    model_end=None, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"M=0.4")
...
MODEL_0_4_MS = MESA_model( 
    mass=0.4, 
    substage=src.data.stars.sub_stage.SUB_MS_MEDMASS, 
    model_start=None, 
    model_example=309, 
    model_end=None, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"M=0.4") 
...
MODEL_0_4_SUBGIANT = MESA_model( 
    mass=0.4, 
    substage=src.data.stars.sub_stage.SUB_POSTMS_SUBGIANT, 
    model_start=None, 
    model_example=450, 
    model_end=None, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"M=0.4") 
...
MODEL_0_4_RG = MESA_model( 
    mass=0.4, 
    substage=src.data.stars.sub_stage.SUB_RG, 
    model_start=None, 
    model_example=3000, 
    model_end=None, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"M=0.4") 
...
MODEL_1_0_NONE = MESA_model( 
    ...
    model_example=None, 
    model_end=None, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"M=1.0")
...
MODEL_1_0_HENYEY = MESA_model( 
    mass=1.0, 
    substage=src.data.stars.sub_stage.SUB_HENYEY, 
    model_start=202,
    model_example=220, 
    model_end=240,
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"M=1.0") 
...
MODEL_1_0_HEFLASH = MESA_model( 
    mass=1.0, 
    substage=src.data.stars.sub_stage.SUB_HEIGN_HEFLASH, 
    model_start=9500, 
    model_example=9700, 
    model_end=10500, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"M=1.0") 
...
MODEL_1_0_HEMS = MESA_model( 
    mass=1.0, 
    substage=src.data.stars.sub_stage.SUB_HEMS, 
    model_start=10500, 
    model_example=10650, 
    model_end=10950, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"M=1.0") 
...
MODEL_1_0_AGB = MESA_model(
    mass=1.0, 
    substage=src.data.stars.sub_stage.SUB_AGB, 
    model_start=10950, 
    model_example=12300, 
    model_end=13600, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"M=1.0") 
...
MODEL_1_0_COWD = MESA_model( 
    mass=1.0, 
    substage=src.data.stars.sub_stage.SUB_WD_CO, 
    model_start=13600, 
    model_example=14300, 
    model_end=14300, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"M=1.0") 
...
MODEL_1_75_NONE = MESA_model( 
    ...
    model_example=None, 
    model_end=None, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"Mass=1.75_models=every5")
...
MODEL_1_75_MS = MESA_model(
    mass=1.75, 
    substage=src.data.stars.sub_stage.SUB_MS_HIMASS, 
    model_start=250, 
    model_example=285, 
    model_end=340, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"Mass=1.75_models=every5")
...
MODEL_1_75_HGAP = MESA_model(
    mass=1.75, 
    substage=src.data.stars.sub_stage.SUB_POSTMS_HGAP, 
    model_start=340, 
    model_example=389, 
    model_end=420, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"Mass=1.75_models=every5")
...
MODEL_3_0_NONE = MESA_model( 
    ...
    model_example=None, 
    model_end=None, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"M=3.0")
...
MODEL_3_0_HESTABLE = MESA_model( 
    mass=3.0, 
    substage=src.data.stars.sub_stage.SUB_HEIGN_STABLE, 
    model_start=None, 
    model_example=None, 
    model_end=None, 
    MESA_folder_path=src.data.file_paths.MESA_data_folder/"M=3.0") 
...
ALL_MODELS_LIST = src.misc.CustomList([ 
    MODEL_0_2_NONE, 
    MODEL_0_2_HAYASHI,
    MODEL_0_2_MS, 
    MODEL_0_2_HEWD, 
